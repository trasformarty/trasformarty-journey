...
const COPY = {
  en: {
    ...
    workEyebrow: "What it is",
    workTitle: "A gentle way to meet what is alive inside.",
    work: [
      "Moving Through means allowing yourself to pass through what is moving inside: a feeling, a body memory, an inner tension, an image, a question, or something that does not yet have a name.",
      "The accompaniment creates a safe space where you can stay with what emerges through presence, listening and graduality — without forcing the process and without needing to understand everything with the mind.",
      "It is not about pushing yourself to feel more than you are ready to feel. It is about slowing down enough to notice what is present, what your body is communicating, and what your system needs in order to feel safer. Moving through, to transform.",
    ],
    whoEyebrow: "When it may help",
    whoTitle: "When something inside is asking for space.",
    who: [
      "This work may be for you when something is moving inside and you do not yet know how to meet it.",
      "When words are no longer enough, and you feel the desire to listen also to what the body is telling you.",
    ],
    signs: [
      "When emotions are present, but difficult to name or express.",
      "When the body holds tension, restlessness or a sense of carrying something inside.",
      "When you are going through a transition and need space to feel, integrate and listen.",
      "When you want to build trust, resilience and inner resources without forcing yourself.",
    ],
    sessionEyebrow: "In a session",
    sessionTitle: "What happens, simply.",
    session: [
      "In a Moving Through session, we begin from what is present.",
      "It may be something you feel in the body, a situation you are living, an emotion that keeps returning, a relational difficulty, a threshold of change, or a quiet inner sense that is hard to name.",
      "From there, we begin to listen. We slow down enough to notice what happens in the body: where something closes, activates, protects itself, or begins to soften.",
      "Through gentle guidance, body awareness and emotional presence, we explore what your system needs in order to feel safer.",
      "We look for the resources that are already there — a breath, an image, a sense of support, a gesture, a good memory, an inner quality, or a place in the body that can sustain you.",
      ...
      "This can happen in person or online: through words, movement, silence, breath, visualization or subtle energetic contact. The body guides the rhythm.",
    ],
  ...
  it: {
    ...
    work: [
      "Moving Through significa “passarci attraverso”. Attraversare ciò che si muove dentro: un’emozione, una memoria del corpo, una tensione, un’immagine, una domanda, o qualcosa che ancora non ha un nome.",
    ...
    whoEyebrow: "Quando può esserti utile",
    whoTitle: "Quando senti qualcosa dentro che si muove.",
    who: [
      "Questo lavoro può essere per te quando non sai ancora come incontrarlo.",
      "Quando le parole non bastano più e senti il desiderio di ascoltare anche ciò che il corpo racconta.",
    ],
    signs: [
    ...
    session: [
      ...
      "Può essere qualcosa che senti nel corpo, una situazione che stai vivendo, un’emozione che ritorna, una difficoltà relazionale, una soglia di cambiamento, o semplicemente un senso interno che non riesci ancora a nominare.",
      "Da lì iniziamo ad ascoltare. Rallentiamo abbastanza da notare cosa accade nel corpo: dove qualcosa si chiude, si attiva, si protegge, oppure dove qualcosa inizia ad ammorbidirsi.",
      "Attraverso una guida delicata, la consapevolezza del corpo e la presenza emotiva, esploriamo ciò di cui il tuo sistema ha bisogno per sentirsi più al sicuro.",
      "Andiamo a riconoscere le risorse che sono già presenti — un respiro, un’immagine, una sensazione di appoggio, un gesto, una memoria buona, una qualità interna o un luogo del corpo che può sostenerti.",
      ...
      "Questo può accadere in presenza o online: attraverso le parole, il movimento, il silenzio, il respiro, la visualizzazione o un contatto energetico sottile. Il corpo guida il ritmo.",
    ],
