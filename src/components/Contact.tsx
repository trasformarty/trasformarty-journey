...
const CONTACT_COPY = {
  en: {
    ...
    send: "Send Message",
    note: "Your email app will open with this message ready to send.",
    subject: "New message from TrasforMarti website",
  },
  it: {
    ...
    note: "Si aprirà la tua app email con il messaggio già pronto da inviare.",
    subject: "New message from TrasforMarti website",
  },
};
      ...
      <div className="container-soft grid md:grid-cols-12 gap-12 md:gap-16">
        ...
        <Reveal delay={150} className="md:col-span-7">
          <form onSubmit={onSubmit} className="leaf-card space-y-5" aria-label={copy.formAria}>
            ...
            <button type="submit" className="w-full sm:w-auto inline-flex items-center justify-center rounded-full bg-forest text-ivory px-8 py-3.5 text-sm hover:bg-forest-deep transition-colors duration-500 shadow-soft">
              {copy.send}
            </button>
          </form>
          <style>{`
